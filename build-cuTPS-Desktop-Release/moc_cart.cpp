...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Cart_t, stringdata) + ofs \
...
const QMetaObject Cart::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Cart.data,
      qt_meta_data_Cart,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Cart.stringdata))
